...
namespace Framework.Common.Helpers
{
    ...
    public class MoneyHelper
    {
        ...
        /// </summary>
        public static string GetMoenyUpperCN(double money)
        {
            try
            {
                return GetCnString(money.ToString());
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        public static string GetMoneyUpperEN(double money)
        {
            try
            {
                return GetEnString(money.ToString());
            }
            catch (Exception ex)
            {
